...
export class FrameAnimation extends Component {
    ...
    protected start(): void {
        this.spriteFrame = this.node.getComponent(UI_Building).building_data.anim.anim;
        this.frameCount = this.node.getComponent(UI_Building).building_data.anim.anim.length;
        if (this.runAtStart) {
            this.Play(this.Loop);
        }
    }
